class SystemFaultListResponse {
  int? status;
  SystemFaultResult? results;

  SystemFaultListResponse({this.status, this.results});

  SystemFaultListResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    results =
    json['results'] != null ? SystemFaultResult.fromJson(json['results']) : null;
  }
...
class SystemFaultResult {
  List<AdminGenerated>? adminGenerated;
  List<GeneralRequestData>? generalRequest;

  SystemFaultResult({this.adminGenerated, this.generalRequest});

  SystemFaultResult.fromJson(Map<String, dynamic> json) {
    if (json['admin_generated'] != null) {
      adminGenerated = <AdminGenerated>[];
      json['admin_generated'].forEach((v) {
        adminGenerated!.add(AdminGenerated.fromJson(v));
      });
    }
    if (json['general_request'] != null) {
      generalRequest = <GeneralRequestData>[];
      json['general_request'].forEach((v) {
        generalRequest!.add(GeneralRequestData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    if (adminGenerated != null) {
      data['admin_generated'] =
          adminGenerated!.map((v) => v.toJson()).toList();
    }
    if (generalRequest != null) {
      data['general_request'] =
          generalRequest!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class GeneralRequestData {
  ...
  GeneralRequestData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
