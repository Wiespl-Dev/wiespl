...
//
//   @override
//   _ManagementHomeState createState() => _ManagementHomeState();
// }
//
...
//                       InkWell(
//                         onTap: ((){
//                           Get.toNamed('/service_error_from', arguments: 1);
//                         }),
//                         child: Container(
...
//                           ),
//                           const Divider(
//                               height: 0.5, thickness: 0.2, color: colorWhite),
//                           verticalView(),
//                           Text(
//                             "04",
...
//                           InkWell(
//                             onTap: (() {
//                               Get.toNamed('/management_plc_service_request', arguments: [false, true,  false]);//isTab, isAssigned, isSolved
//                             }),
//                             child: Container(
...
//                           InkWell(
//                             onTap: (() {
//                               Get.toNamed('/management_plc_service_request', arguments: [false, false,  true]);//isTab, isAssigned, isSolved
//                             }),
//                             child: Container(
//                               width: MediaQuery.of(context).size.width / 3.2,
//                               decoration: const BoxDecoration(
