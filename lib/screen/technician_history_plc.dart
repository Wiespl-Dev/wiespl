...
import 'package:wiespl/model/technician_history_response.dart';
...
class TechnicianHistoryPlc extends StatefulWidget {
  const TechnicianHistoryPlc({Key? key}) : super(key: key);

  @override
  State<TechnicianHistoryPlc> createState() => _TechnicianHistoryPlcState();
}

class _TechnicianHistoryPlcState extends State<TechnicianHistoryPlc>
